    ...
    <Box>
      ...
      <Flex align="center" justify="space-between" gap={2}>
        <VStack spacing={1} align="center" flex={1}>
          ...
          <Text fontFamily="mono" fontSize={{ base: "7px", md: "9px" }} color="brand.bone" textTransform="uppercase"
        ...
        <Box textAlign="center" px={2}>
          {homeScore !== null && awayScore !== null ? (
            <HStack spacing={1} justify="center">
              <Text fontFamily="heading" fontSize={{ base: "md", md: "xl" }} color="brand.amber" lineHeight={1}>
                {homeScore}
              </Text>
              <Text fontFamily="heading" fontSize={{ base: "7px", md: "9px" }} color="brand.dorado" lineHeight={1}>
                —
              </Text>
              <Text fontFamily="heading" fontSize={{ base: "md", md: "xl" }} color="brand.amber" lineHeight={1}>
                {awayScore}
            ...
            <Text fontFamily="heading" fontSize={{ base: "10px", md: "xl" }} color="brand.amber" letterSpacing="wider">
              VS
            </Text>
          )}
          {competition && (
      ...
      <Flex mt={{base: 2 ,md: 4}} justify="space-between" align="flex-end">
        ...
        {stadium && (
          <Text fontFamily="mono" fontSize="8px" color="brand.gray" letterSpacing="wider"
                textAlign="right" maxW="120px" noOfLines={1}>
            {stadium}
          </Text>
        )}
      </Flex>
    ...
    >
      ...
      {hasScore && (
        <VStack spacing={1.5} align="center">
          <Shield src={last.home.shield} name={last.home.name} size="30px" />
          <Flex spacing={0.5} justify="center" direction="column" align="center">
            <Text fontFamily="heading" fontSize="md" color="brand.amber" lineHeight={1}>
              {last.homeScore}
            </Text>
            <Text fontFamily="heading" fontSize="xs" color="brand.dorado" lineHeight={1}>
              —
            </Text>
            <Text fontFamily="heading" fontSize="md" color="brand.amber" lineHeight={1}>
              {last.awayScore}
          ...
          <Shield src={last.away.shield} name={last.away.name} size="30px" />
        </VStack>
      )}
            ...
            >
              ...
              <VStack spacing={{ base: 4, md: 6 }} align="stretch">
                ...
                <Flex justify="flex-end" align="center" gap={4}>
                  <Box h="1px" bg="brand.amberLight" w="80%" alignSelf="center" my={2} />
                  <Box
                    as="button"
                    type="button"
